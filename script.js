...
const mainLight = new THREE.PointLight(0xffffff, 35, 30);
  ...
  setTimeout(() => {
    ...
    setTimeout(() => {
      ...
      */
      ...
      candleLab.style.visibility = "visible";
      candleLab.style.opacity = "1";
      candleLab.style.pointerEvents = "auto";
...
backButton.addEventListener("click", () => {
  ...
  candleLab.style.pointerEvents = "none";

  setTimeout(() => {

    candleLab.style.display = "none";
    candleLab.style.visibility = "hidden";
    ...
    homeUI.style.visibility = "visible";
